...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            var empQuery = Emps.Select(emp => new { emp.Ename, emp.Job, emp.HireDate }).Cast<object>();
            var unionQuery = empQuery.Union(new[] { new { Ename = "Brak wartości", Job = (string)null, HireDate = (DateTime?)null } });
            return unionQuery;
        }
